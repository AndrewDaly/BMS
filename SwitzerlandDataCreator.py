...
directory = "Switzerland Global ID " + globalID
path = os.path.join(os.getcwd(), directory)
os.mkdir(path)

# Customize RR email
RRemail = SwitzerlandStrings.RRFirstName + SwitzerlandStrings.RRLastName + str(globalID)[5:] + "@bms.com"
#RRemail = "CHEUATVAL@protonmail.com"
...
sheet["A2"] = globalID
sheet["B2"] = SwitzerlandStrings.accountName
sheet["C2"] = "Hospital"
sheet["D2"] = SwitzerlandStrings.product
sheet["F2"] = SwitzerlandStrings.siteAddress
sheet["G2"] = SwitzerlandStrings.siteCity
sheet["I2"] = SwitzerlandStrings.siteZip
sheet["J2"] = SwitzerlandStrings.country
...
sheet["B2"] = SwitzerlandStrings.RRFirstName
sheet["C2"] = SwitzerlandStrings.RRLastName
sheet["D2"] = "Authorized Representative"
sheet["E2"] = globalID
sheet["F2"] = SwitzerlandStrings.accountName
sheet["G2"] = SwitzerlandStrings.RRCredentials
sheet["H2"] = SwitzerlandStrings.RRPhone
sheet["I2"] = SwitzerlandStrings.RRFax
sheet["J2"] = RRemail
sheet["K2"] = SwitzerlandStrings.product
...
sheet["G1"] = "Global_ID"
sheet["B2"] = SwitzerlandStrings.FMRFirstName
sheet["C2"] = SwitzerlandStrings.FMRLastName
sheet["D2"] = SwitzerlandStrings.FMRTitle + str(globalID)[5:] + "@bms.com"
sheet["E2"] = SwitzerlandStrings.FMRPhone
sheet["F2"] = SwitzerlandStrings.FMRTitle
sheet["G2"] = globalID
sheet["B3"] = SwitzerlandStrings.KAMFirstName
sheet["C3"] = SwitzerlandStrings.KAMLastName
sheet["D3"] = SwitzerlandStrings.KAMEmail
sheet["E3"] = SwitzerlandStrings.KAMPhone
sheet["F3"] = SwitzerlandStrings.KAMTitle
sheet["G3"] = globalID
