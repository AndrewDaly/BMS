...
directory = "UK Global ID " + globalID
path = os.path.join(os.getcwd(), directory)
os.mkdir(path)

# Customize RR email
RRemail = UKStrings.RRFirstName + UKStrings.RRLastName + str(globalID)[5:] + "@bms.com"
...
sheet["A2"] = globalID
sheet["B2"] = UKStrings.accountName
sheet["C2"] = "Hospital"
sheet["D2"] = UKStrings.product
sheet["F2"] = UKStrings.siteAddress
sheet["G2"] = UKStrings.siteCity
sheet["I2"] = UKStrings.siteZip
sheet["J2"] = UKStrings.country
...
sheet["B2"] = UKStrings.RRFirstName
sheet["C2"] = UKStrings.RRLastName
sheet["D2"] = "Authorized Representative"
sheet["E2"] = globalID
sheet["F2"] = UKStrings.accountName
sheet["G2"] = UKStrings.RRCredentials
sheet["H2"] = UKStrings.RRPhone
sheet["I2"] = UKStrings.RRFax
sheet["J2"] = RRemail
sheet["K2"] = UKStrings.product
...
sheet["G1"] = "Global_ID"
sheet["B2"] = UKStrings.FMRFirstName
sheet["C2"] = UKStrings.FMRLastName
sheet["D2"] = UKStrings.FMRTitle + str(globalID)[5:] + "@bms.com"
sheet["E2"] = UKStrings.FMRPhone
sheet["F2"] = UKStrings.FMRTitle
sheet["G2"] = globalID
sheet["B3"] = UKStrings.KAMFirstName
sheet["C3"] = UKStrings.KAMLastName
sheet["D3"] = UKStrings.KAMEmail
sheet["E3"] = UKStrings.KAMPhone
sheet["F3"] = UKStrings.KAMTitle
sheet["G3"] = globalID
